...
public class MissionsDemoBaseActivity extends FragmentActivity implements SurfaceTextureListener {

    private static final String TAG = MissionsMainActivity.class.getName();
    ...
    private void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(MissionsDemoBaseActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initPreviewer() {
        try {
            mProduct = DemoApplication.getProductInstance();
    ...
    private void updateTitleBar() {
        ...
        if (product != null) {
            if(product.isConnected()) {
                mConnectStatusTextView.setText(DemoApplication.getProductInstance().getModel().getDisplayName() + " Connected");
                ret = true;
            } else {

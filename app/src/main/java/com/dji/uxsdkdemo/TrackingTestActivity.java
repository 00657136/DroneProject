...
public class TrackingTestActivity extends MissionsDemoBaseActivity implements SurfaceTextureListener, OnClickListener, OnTouchListener, CompoundButton.OnCheckedChangeListener, ActiveTrackMissionOperatorListener {
    ...
    private Button ScreenCapture;
    private  Button UploadScreenCapture;
    public Uri imguri;
    ...
    private void initUI() {
        ...
        //截圖
        ScreenCapture = (Button) findViewById(R.id.ScreenCapture);
        ScreenCapture.setOnClickListener(this);
        ScreenShotView = (ImageView) findViewById(R.id.ScreenShotView);
        UploadScreenCapture = (Button) findViewById(R.id.UploadScreenCapture);
        UploadScreenCapture.setOnClickListener(this);
    ...
    public void screencapture(View view){
        ...
        Bitmap textureViewBitmap = mVideoSurface.getBitmap();

        ScreenShotView.setImageBitmap(textureViewBitmap);

        String mPath = Environment.getExternalStorageDirectory().toString() + "/DroneFiles";
        ...
        try {
            ...
            int quality = 100;
            textureViewBitmap.compress(Bitmap.CompressFormat.JPEG, quality, outputStream);
            outputStream.flush();
            outputStream.close();
            Toast.makeText(TrackingTestActivity.this,"已存入內部儲存空間",Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    {
        StorageReference Ref = mStorageRef.child(System.currentTimeMillis()+".jpg"); //+getExtension(imguri)
        Ref.putFile(imguri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(TrackingTestActivity.this,"圖片上傳成功",Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        // ...
                        Toast.makeText(TrackingTestActivity.this,"圖片上傳失敗",Toast.LENGTH_LONG).show();
                    }
                });
    }
